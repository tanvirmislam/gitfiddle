class Node {
  ...
  _init (id, diameter) {
    ...
    this._gitCommitInfo = undefined
  }

  set x (val) { this._x = val }
  set y (val) { this._y = val }
  set d (val) { this._d = val; this._r = val * 0.5 }
  ...
  set gitCommitInfo (commitInfo) { this._gitCommitInfo = commitInfo }
  ...
  get gitCommitInfo () { return this._gitCommitInfo }
