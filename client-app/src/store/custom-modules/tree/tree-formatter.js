class TreeFormatter {
    ...
    adjustTree (tree) {
      ...
      const yIncrement = Math.min(100, ((this._canvasHeight - this._margin) / tree.info.levelOrder.length))
    ...
    _recursivelyAdjust (node, minX, maxX, y, yIncrement) {
      ...
      const childrenSpace = (space / node.children.length)
      let startX = minX
